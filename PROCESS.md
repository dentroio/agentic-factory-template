...
| **P3** | Docs / PM markdown only | No | PR required if `main` is protected |

One line of application code makes it at least P2.
...
9. P2: auto-merge after CI. P0/P1: human merges.
